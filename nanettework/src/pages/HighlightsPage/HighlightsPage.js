    ...
    return (
        <div className='aboutLayout'>
          ...
          <div className='bio'>
            <div className='words'>
              <h2>2022👩🏽‍🎓</h2>
              <h3>August 6 2022: I officially became the first person in my family to complete an American university! <a href='https://www.everythinglubbock.com/news/local-news/texas-tech-2022-summer-commencement-schedule-announced/' target={"_blank"} rel="noreferrer">We were decked out or whatever during ceremony.</a>✨</h3>
              <h3>I recieved an award from the <a href='https://www.everythinglubbock.com/news/local-news/honorees-receive-presidents-excellence-awards-in-diversity-equity-inclusion-gender-equity/' target={"_blank"} rel='noreferrer'>Texas Tech President</a> recognizing my campus-wide efforts in advancing diversity, equity, and inclusion. Wreck 'em for life!</h3>
              <h3>I spent my senior year researching the relationship between the immigration status and a child's well being <a href='https://www.depts.ttu.edu/honors/academicsandenrichment/thesis/ThesisDay2022.php' target={"_blank"} rel='noreferrer'>with Dr. Johnson.</a> Publication details OTW!</h3>
              <h2>2021</h2>
              ...
              <h3>I receieved the Texas High School Coaches Association 2017-2018 Academic All-State Recipient to successfully <a href='https://twitter.com/texashstennis/status/1008883887592927232' target={'_blank'} rel='noreferrer'>wrap up a decade worth of tennis-ing.</a></h3>
              <h2>2013</h2>
